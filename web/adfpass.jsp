...
<%
   try
   {
        ...
        String  ans = request.getParameter("ss");
        Class.forName("com.mysql.jdbc.Driver");
        con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Project","root","");
        ps = con.prepareStatement("select Password from admin where  Admin_Name=? and Answer=? ");
        ps.setString(1, Name);
        ps.setString(2, ans);
        rs = ps.executeQuery();
        if(!rs.next())
...
%>
<hr>
    <center><a href="index.html">Home</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.jsp">Logout</a></center>
    <hr>
    </body>
</html>
