                ...
                <td>
                  ...
                  <tr>
                   <td>Marks Obtained</td>
                    <td><% 
          String s1=request.getParameter("cs1");
          String s2=request.getParameter("cs2");
          String s3=request.getParameter("cs3");
          String s4=request.getParameter("cs4");
          String s5=request.getParameter("cs5");
          String s6=request.getParameter("cs6");
          String s7=request.getParameter("cs7");
          String s8=request.getParameter("cs8");
          String s9=request.getParameter("cs9");
          String s10=request.getParameter("cs10");
         ...
         else
         {
              ...
              st.executeUpdate("insert into res values('"+dd+"',"+r1+","+i1+",'"+s11+"',"+count+",'"+s5+"')");
                ...
                <center><a class="next" style="text-decoration: none;" href="Finish.jsp">Finish</a>&nbsp;&nbsp;&nbsp;
                    <a  style="text-decoration: none;" class="next" href="answer3.jsp?id=<%=e1%>">View Answer</a></center><br> 
