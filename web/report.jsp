...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Project","root","");
    ...
    ResultSet rs=st.executeQuery("select  s.Fname, s.s_id, s.Uname,s.DOB,s.Gender,s.Reg_Date,exam7.exam_name,r.marks_obtained,r.remarks from students s INNER JOIN  res r ON s.s_id=r.s_id INNER JOIN  exam7 ON r.E_id=exam7.E_id ");
    %> 
    <table border="1">   
    <tr>
