                ...
                <td>
                  ...
                  <tr>
                   <td>Marks Obtained</td>
                    <td><% 
          String s1=request.getParameter("cp1");
          String s2=request.getParameter("cp2");
          String s3=request.getParameter("cp3");
          String s4=request.getParameter("cp4");
          String s5=request.getParameter("cp5");
          String s6=request.getParameter("cp6");
          String s7=request.getParameter("cp7");
          String s8=request.getParameter("cp8");
          String s9=request.getParameter("cp9");
          String s10=request.getParameter("cp10");
         ...
         else
         {
              ...
              st.executeUpdate("insert into res values('"+dd+"',"+r1+","+i1+",'"+s11+"',"+count+",'"+s5+"')");
                ...
                <center><a class="next" style="text-decoration: none;" href="Finish.jsp">Finish</a>&nbsp;&nbsp;&nbsp;
                    <a  style="text-decoration: none;" class="next" href="answer5.jsp?id=<%=e1%>">View Answer</a></center><br> 
